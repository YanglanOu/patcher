...
model = dict( 
    ...
    test_cfg=dict(mode='slide', crop_size=(352,352), stride=(352,352), vis=True))
...
img_norm_cfg = dict(
    mean=[x * 255 for x in [0.485, 0.456, 0.406]], std=[x * 255 for x in [0.229, 0.224, 0.225]], to_rgb=False)
crop_size = (256, 256)
train_pipeline = [
