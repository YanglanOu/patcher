...
model = dict(
    ...
    backbone=dict(
        ...
        patch_sizes=[2,2,2,2], in_chans=2, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
        qkv_bias=True, depths=[3, 6, 40, 3], sr_ratios=[2, 2, 2, 1],
        drop_rate=0.0, drop_path_rate=0.1),
    decode_head=dict(
        type='PatchFormerHead',
        prescale_mlp_dims=[256], # new
        prescale_mlp_final_act=False,
        afterscale_mlp_dims=[256], # new
        afterscale_mlp_final_act=False,
