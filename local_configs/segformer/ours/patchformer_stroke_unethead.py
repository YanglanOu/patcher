...
model = dict(
    ...
    backbone=dict(
        type='PatchTransformer', img_size=256, patch_block_type='patchblock',
        patch_sizes=[2,2,2,2], in_chans=2, embed_dims=[64, 128, 256, 512], num_heads=[1, 2, 4, 8], mlp_ratios=[4, 4, 4, 4],
