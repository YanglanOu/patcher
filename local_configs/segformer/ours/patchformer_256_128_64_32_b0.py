...
model = dict(
    ...
    backbone=dict(
        ...
        large_patch=[256,128,64,32], context_padding=[0,0,0,0],
        patch_sizes=[2,2,2,2], in_chans=2, embed_dims=[32, 64, 160, 256], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
        qkv_bias=True, depths=[2, 2, 2, 2], sr_ratios=[2, 2, 2, 1],
        drop_rate=0.0, drop_path_rate=0.1, pos_embed=False),
    decode_head=dict(
        type='SegFormerHead',
